  ...
  return (
    <section className="w-full h-auto">
        <div className='pb-16 h-auto'>
            <div className='relative top-12 max-w-[520px] md:max-w-[1450px] m-auto'>
                <Image className=' absolute top-48 left-48 md:top-80 md:left-96 w-48 md:w-80 h-28 md:h-48' src='/assets/images/inscription.png' alt='/' width={200} height={200} />
                <Image className=' absolute z-[-2] top-0 right-0 md:left-28 w-32 md:w-48 h-32 md:h-48' src='/assets/images/block.png' alt='/' width={200} height={200} />
                ...
                <div className="relative text-[#3c4e3d] text-6xl md:text-9xl pt-20 w-full">
            ...
            <div className='md:grid md:grid-cols-2 relative top-12 max-w-[520px] md:max-w-[1250px] m-auto mt-10 md:mt-0'>
