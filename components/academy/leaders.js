    ...
    <section className="w-full h-auto">
        <div className='pb-16 h-auto'>
            <div className='relative top-12 max-w-[600px] md:max-w-[1450px] m-auto'>
                <Image className=' absolute top-48 left-48 md:top-80 md:left-96 w-48 sm:w-56 lg:w-80 h-28 sm:h-32 lg:h-48' src='/assets/images/inscription.png' alt='/' width={200} height={200} />
                ...
                <div className="relative text-[#3c4e3d] text-6xl sm:text-7xl lg:text-9xl pt-20 w-full">
                    <h1 className="max-w-[450px] lg:hidden ml-auto">Powered by</h1>
                    <h1 className="hidden lg:block md:max-w-[1350px] mr-auto">Powered by</h1>
