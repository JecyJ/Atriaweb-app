    ...
    <section className='relative w-full h-auto'>
        <div className='max-w-[520px] md:max-w-[1250px] m-auto'>
            <ul className='border-t border-t-[#3c4e3d] border-t-3  my-20'>
                ...
                <li className='relative md:z-[2] text-[#3c4e3d] text-5xl lg:text-7xl font-semibold'>By dilligently monitoring and modifying existing standards of care, we're creating a new system of modern medicine.</li>
            </ul>
