  ...
  return (
    <section className='w-full mb-20'>
      <div className='relative z-[-2] pb-10'>
        <Image className=' absolute z-[2] right-11 md:right-28 w-2/6 md:w-2/12 h-64 md:h-2/4' src='/assets/images/stones.png' alt='/' width={200} height={200} />
        <ul className='relative top-12 border-t border-t-[#3c4e3d] border-t-3 max-w-[520px] md:max-w-[1250px] m-auto my-20'>
            ...
            <li className='relative md:z-[2] text-[#3c4e3d] text-4xl md:text-7xl font-semibold'>Atria is on a mission to create a new paradigm in medicine. Our approach to health is guided by world-class experts who translate cutting-edge, evidence-based scientific research into medicine in real time.</li>
        </ul>
