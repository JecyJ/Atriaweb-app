...
const Hero = () => {
  return (
    <section className="w-full h-auto mt-28 sm:mt-44">
      <div className="max-w-[520px] sm:max-w-[620px] md:max-w-[1200px] m-auto">
        ...
        <div className='md:hidden'>
          <div className='grid grid-cols-4 gap-4 text-lg text-[#3c4e3d] font-semibold leading-none md:max-w-[580px] ml-auto mt-20'>
            <h3>The future of health</h3>
            <h3></h3>
            <h3>brought to you today.</h3>
          </div>
          <div className='max-w-[270px] mt-12'>
            <h3 className='text-[#3c4e3d] text-base leading-tight'>We are powering a movemnt for proactive, preventive healthcare informed by cutting-edge science and technology.</h3>
          </div>
        </div>
      </div>
    </section>
