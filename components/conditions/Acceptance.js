    ...
    <section className='w-full h-auto my-20'>
        <div className='max-w-[370px] sm:max-w-[570px] md:max-w-[770px] lg:max-w-[1200px] m-auto'>
            <ul className='text-[#3c4e3d] text-base font-semibold leading-tight space-y-16 sm:space-y-36'>
                ...
                <li className='w-full border-top border-t-2 border-[#3c4e3d]'>
                  <div className='sm:flex justify-between space-y-7 sm:space-y-0 pt-10 sm:pt-20'>
                    <h3 className='w-full md:max-w-[300px]'>Information About You and Your Use of the Platform</h3>
                    <div className='space-y-6'>
                        <p className='md:max-w-[1100px]'>
                        Please refer to our Privacy Policy to learn about our privacy practices with respect to your personal information. <span className="text-[#3c4e3d]/60">Please refer to our Notice of Privacy Practices to learn about our privacy practices with respect to your Protected Health Information.</span>
                        </p>
                    </div>
                  </div>                  
                </li>
                ...
                <li className='w-full border-top border-t-2 border-[#3c4e3d]'>
                  <div className='sm:flex justify-between space-y-7 sm:space-y-0 pt-10 sm:pt-20'>
                    <h3 className='w-full md:max-w-[300px]'>Accessing the Platform</h3>
                    <div className='space-y-6'>
                        <p className='md:max-w-[1100px]'>
                        We reserve the right to withdraw or amend the Platform, and any material we provide on the Platform, in our sole discretion without notice. We will not be liable if, for any reason, all or any part of the Platform is unavailable at any time or for any period. <span className="text-[#3c4e3d]/60">From time to time, we may restrict access to some parts of the Platform or the entirety of the Platform.</span>
                        </p>
                        <p className='md:max-w-[1100px] text-[#3c4e3d]/60'>
                        You agree that all information you provide to the Website and iOS mobile Platform is governed by our Privacy Policy and Notice of Privacy Practices and you consent to all actions we take with respect to your information consistent with our Privacy Policy.
                        </p>
                        <p className='md:max-w-[1100px] text-[#3c4e3d]/60'>
                  ...
                  <div className='sm:flex justify-between space-y-7 sm:space-y-0 pt-10 sm:pt-20'>
                    ...
                    <div className='space-y-6'>
                        ...
                        <ul className="list-disc list-inside">
                            <li className='md:max-w-[1100px] text-[#3c4e3d]/60'>
                ...
                <li className='w-full border-top border-t-2 border-[#3c4e3d]'>
                  <div className='sm:flex justify-between space-y-7 sm:space-y-0 pt-10 sm:pt-20'>
                    <h3 className='w-full md:max-w-[300px]'>Prohibited Uses</h3>
                    <div className='space-y-6'>
                        <p className='md:max-w-[1100px]'>
                ...
                <li className='w-full border-top border-t-2 border-[#3c4e3d]'>
                  <div className='sm:flex justify-between space-y-7 sm:space-y-0 pt-10 sm:pt-20'>
                    <h3 className='w-full md:max-w-[300px]'>Reliance on Information Posted</h3>
                    <div className='space-y-6'>
                        <p className='md:max-w-[1100px]'>
                        The Platform may include content provided by third parties. All statements and/or opinions expressed in these materials, and responses to questions and other content, other than the content we provide, are solely the opinions and the responsibility of the person or entity providing those materials.  <span className="text-[#3c4e3d]/60">These materials do not necessarily reflect our opinion. We are not responsible, or liable to you or any third party, for the content or accuracy of any materials provided by any third parties.</span>
                        </p>
                    </div>
                  </div>                  
                </li>
                ...
                <li className='w-full border-top border-t-2 border-[#3c4e3d]'>
                  <div className='sm:flex justify-between space-y-7 sm:space-y-0 pt-10 sm:pt-20'>
                    <h3 className='w-full md:max-w-[300px]'>Electronic Communications</h3>
                    <div className='space-y-6'>
                        <p className='md:max-w-[1100px]'>
                        ...
                        <p className='md:max-w-[1100px] text-[#3c4e3d]/60'>
                        By providing your e-mail address, you are agreeing to be contacted by or on behalf of Atria at e-mail, to receive marketing-related information. These communications may not be secure. Unsecured communications pose a risk to the confidentiality and privacy of information being sent because they might be intercepted by a third party. You can opt out of receiving one of our e-mails by following the instructions for unsubscribing contained in the e-mails or by e-mailing info@atria.org and asking to be removed from the mailing list. Please allow us ten (10) business days from when the request was received to complete the removal. Please note that even if you unsubscribe from commercial e-mail messages, we may still e-mail you non-commercial (transactional) e-mails related to your account and your transactions via the Platform.
                        </p>
                    </div>                    
                  </div>                  
                </li>
                <li className='w-full border-top border-t-2 border-[#3c4e3d]'>
                  <div className='sm:flex justify-between space-y-7 sm:space-y-0 pt-10 sm:pt-20'>
                    <h3 className='w-full md:max-w-[300px]'>Terms of Sale</h3>
                    <div className='space-y-6'>
                        <p className='md:max-w-[1100px]'>
                ...
                <li className='w-full border-top border-t-2 border-[#3c4e3d]'>
                  <div className='sm:flex justify-between space-y-7 sm:space-y-0 pt-10 sm:pt-20'>
                    <h3 className='w-full md:max-w-[300px]'>Geographic Restrictions</h3>
                    <div className='space-y-6'>
                        <p className='md:max-w-[1100px]'>
                        The owner of the Platform is based in the United States. We provide the Platform for use only by persons located in the United States. We make no claims or representations that the Platform or any of their content is accessible or appropriate outside of the United States. <span className="text-[#3c4e3d]/60"> Access to the Platform may not be legal by certain persons or in certain countries. If you access the Platform from outside the United States, you do so on your own initiative and are responsible for compliance with local laws.</span>
                        </p>
                    </div>
                  </div>                  
                </li>
                ...
                <li className='w-full border-top border-t-2 border-[#3c4e3d]'>
                  <div className='sm:flex justify-between space-y-7 sm:space-y-0 pt-10 sm:pt-20'>
                    <h3 className='w-full md:max-w-[300px]'>Disclaimer of Warranties</h3>
                    <div className='space-y-6'>
                        <p className='md:max-w-[1100px]'>
                        You understand that we cannot and do not guarantee or warrant that authorized files or content available for downloading from the Platform or the internet will be free of viruses, malware or other destructive code. You are responsible for implementing sufficient procedures and checkpoints to satisfy your particular requirements for anti-virus protection and accuracy of data input and output, and for maintaining a means external to our Platform for any reconstruction of any lost data. <span className="text-[#3c4e3d]/60"> WE WILL NOT BE LIABLE FOR ANY LOSS OR DAMAGE CAUSED BY A DISTRIBUTED DENIAL-OF-SERVICE ATTACK, VIRUS OR OTHER TECHNOLOGICALLY HARMFUL MATERIAL THAT MAY INFECT YOUR COMPUTER EQUIPMENT, COMPUTER PROGRAMS, DATA OR OTHER PROPRIETARY MATERIAL DUE TO YOUR USE OF THE PLATFORM OR ANY ITEMS OBTAINED THROUGH THE PLATFORM OR TO YOUR DOWNLOADING OF ANY MATERIAL POSTED ON THE PLATFORM, OR ON ANY WEBSITE LINKED TO THE PLATFORM.</span>
                        </p>
                        <p className="md:max-w-[1100px] text-[#3c4e3d]/60">
                ...
                <li className='w-full border-top border-t-2 border-[#3c4e3d]'>
                  <div className='sm:flex justify-between space-y-7 sm:space-y-0 pt-10 sm:pt-20'>
                    <h3 className='w-full md:max-w-[300px]'>Limitation on Liability</h3>
                    <div className='space-y-6'>
                        <p className='md:max-w-[1100px]'>
                ...
                <li className='w-full border-top border-t-2 border-[#3c4e3d]'>
                  <div className='sm:flex justify-between space-y-7 sm:space-y-0 pt-10 sm:pt-20'>
                    <h3 className='w-full md:max-w-[300px]'>Termination</h3>
                    <div className='space-y-6'>
                        <p className='md:max-w-[1100px]'>
                        We may terminate your use of the Platform for any or no reason at any time. <span className="text-[#3c4e3d]/60"> YOU AGREE THAT WE WILL NOT BE LIABLE TO YOU OR ANY OTHER PARTY FOR ANY TERMINATION OF YOUR ACCESS TO THE PLATFORM.</span>
                        </p>
                    </div>
                  </div>                  
                </li>
                <li className='w-full border-top border-t-2 border-[#3c4e3d]'>
                  <div className='sm:flex justify-between space-y-7 sm:space-y-0 pt-10 sm:pt-20'>
                    <h3 className='w-full md:max-w-[300px]'>Dispute Resolution</h3>
                    <div className='space-y-6'>
                        <p className='md:max-w-[1100px]'>
                        In the event of any dispute, claim, question, or disagreement arising from or relating to these Terms and Conditions, we and you (collectively, the “Parties”) shall use their best efforts to settle the dispute, claim, question, or disagreement. <span className="text-[#3c4e3d]/60"> To this effect, the Parties shall consult and negotiate with each other in good faith and, recognizing their mutual interests, attempt to reach a just and equitable solution satisfactory to both Parties. If the Parties do not reach such solution within a period of thirty (30) days, then all disputes shall be resolved by binding arbitration. The arbitration shall be conducted by and submitted to a single arbitrator and administered by the American Arbitration Association (“AAA”), in accordance with its then existing rules; however, upon the written demand of any party to the arbitration, the arbitration shall be conducted by and submitted to three Arbitrators. The arbitration hearing shall be held in New York, New York. Depositions may be taken and full discovery may be obtained in any arbitration commenced under this arbitration provision.</span>
                        </p>
                        <p className="md:max-w-[1100px] text-[#3c4e3d]/60">
                ...
                <li className='w-full border-top border-t-2 border-[#3c4e3d]'>
                  <div className='sm:flex justify-between space-y-7 sm:space-y-0 pt-10 sm:pt-20'>
                    <h3 className='w-full md:max-w-[300px]'>Membership Fees</h3>
                    <div className='space-y-6'>
                        <p className='md:max-w-[1100px]'>
                        ...
                        <p className="md:max-w-[1100px]">
                        You agree to make the payment of the Annual Membership Fee using your chosen payment method.
                        </p>
                        <p className="md:max-w-[1100px]">
                ...
                <li className='w-full border-top border-t-2 border-[#3c4e3d]'>
                  <div className='sm:flex justify-between space-y-7 sm:space-y-0 pt-10 sm:pt-20'>
                    <h3 className='w-full md:max-w-[300px]'>Miscellaneous</h3>
                    <div className='space-y-6'>
                        <p className="md:max-w-[1100px] text-[#3c4e3d]/60">
                ...
                <li className='w-full border-top border-t-2 border-[#3c4e3d]'>
                  <div className='sm:flex justify-between space-y-7 sm:space-y-0 pt-10 sm:pt-20'>
                    <h3 className='w-full md:max-w-[300px]'>Your Comments and Concerns</h3>
                    <div className='space-y-6'>
                        <p className='md:max-w-[1100px]'>
                        The Platform is operated by Atria. All feedback, comments, requests for technical support and other communications relating to the Platform should be directed to info@atria.org.
                        </p>
                        <p className="md:max-w-[1100px] text-[#3c4e3d]/60">
