...
const Practice = () => {
  return (
    <section className='w-full h-auto my-20'>
        <div className='max-w-[400px] sm:max-w-[570px] md:max-w-[770px] lg:max-w-[1200px] m-auto'>
                  ...
                  <div className='sm:flex justify-between space-y-7 sm:space-y-0 pt-10 sm:pt-20'>
                    ...
                    <div className='space-y-7'>
                      ...
                      <ul className='list-[upper-roman] text-[#3c4e3d]/60 space-y-7'>
                        ...
                        <li>
                        Organ and Tissue Procurement. We may disclose your PHI to organizations that facilitate organ, eye or tissue procedure, banking or transplantation.
                        </li>
                        <li>
